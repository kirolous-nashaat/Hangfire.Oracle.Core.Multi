...
namespace Hangfire.Oracle.Core
{
    internal class OracleWriteOnlyTransaction : JobStorageTransaction
    {
        ...
        public OracleWriteOnlyTransaction(OracleStorage storage, OracleStorageOptions options)
        {
        ...
        public override void ExpireJob(string jobId, TimeSpan expireIn)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}{prefix}HF_JOB SET EXPIRE_AT = :EXPIRE_AT WHERE ID = :ID",
        ...
        public override void PersistJob(string jobId)
        {
            ...
            QueueCommand(x => x.Execute($"UPDATE {prefix}HF_JOB SET EXPIRE_AT = NULL WHERE ID = :ID", new { ID = jobId }));
        }
        ...
        public override void SetJobState(string jobId, IState state)
        {
            ...
            var stateId = _storage.UseConnection(connection => connection.GetNextId(prefix));
            ...
            QueueCommand(x => x.Execute(
                $@"
BEGIN
 INSERT INTO {prefix}HF_JOB_STATE (ID, JOB_ID, NAME, REASON, CREATED_AT, DATA)
      VALUES (:STATE_ID, :JOB_ID, :NAME, :REASON, :CREATED_AT, :DATA);
 
      UPDATE {prefix}HF_JOB SET STATE_ID = :STATE_ID, STATE_NAME = :NAME WHERE ID = :ID;
END;
",
        ...
        public override void AddJobState(string jobId, IState state)
        {
            ...
            QueueCommand(x => x.Execute(
                $" INSERT INTO {prefix}HF_JOB_STATE (ID, JOB_ID, NAME, REASON, CREATED_AT, DATA) " +
                $"      VALUES ({prefix}HF_SEQUENCE.NEXTVAL, :JOB_ID, :NAME, :REASON, :CREATED_AT, :DATA)", oracleDynamicParameters));
        }
        ...
        public override void IncrementCounter(string key)
        {
            ...
            QueueCommand(x => x.Execute($"INSERT INTO {prefix}HF_COUNTER (ID, KEY, VALUE) values ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE)",
                    new { KEY = key, VALUE = +1 }));
        }
        ...
        public override void IncrementCounter(string key, TimeSpan expireIn)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"INSERT INTO {prefix}HF_COUNTER (ID, KEY, VALUE, EXPIRE_AT) values ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE, :EXPIRE_AT)",
        ...
        public override void DecrementCounter(string key)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"INSERT INTO {prefix}HF_COUNTER (ID, KEY, VALUE) values ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE)",
                    new { KEY = key, VALUE = -1 }));
        }
 ...
 WHEN NOT MATCHED THEN
      ...
      VALUES ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE, :SCORE)
",
        ...
        public override void AddRangeToSet(string key, IList<string> items)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"INSERT INTO {prefix}HF_SET (ID, KEY, VALUE, SCORE) VALUES ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE, 0.0)",
        ...
        public override void RemoveFromSet(string key, string value)
        {
            ...
            AcquireSetLock();
            QueueCommand(x => x.Execute($"DELETE FROM {prefix}HF_SET WHERE KEY = :KEY AND VALUE = :VALUE", new { KEY = key, VALUE = value }));
        }
        ...
        public override void ExpireSet(string key, TimeSpan expireIn)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}HF_SET SET EXPIRE_AT = :EXPIRE_AT WHERE KEY = :KEY",
        ...
        public override void InsertToList(string key, string value)
        {
            ...
            QueueCommand(x => x.Execute($"INSERT INTO {prefix}HF_LIST (ID, KEY, VALUE) VALUES ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE)", oracleDynamicParameters));
        }
        ...
        public override void ExpireList(string key, TimeSpan expireIn)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}HF_LIST SET EXPIRE_AT = :EXPIRE_AT WHERE KEY = :KEY",
                    new { KEY = key, EXPIRE_AT = DateTime.UtcNow.Add(expireIn) }));
        }
        ...
        public override void RemoveFromList(string key, string value)
        {
            ...
            AcquireListLock();
            QueueCommand(x => x.Execute(
                $"DELETE FROM {prefix}HF_LIST WHERE KEY = :KEY AND VALUE = :VALUE",
...
where lst.Key = @key
    and ranked.rankvalue not between @start and @end",
        ...
        public override void PersistHash(string key)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}HF_HASH SET EXPIRE_AT = NULL WHERE KEY = :KEY", new { KEY = key }));
        }
        ...
        public override void PersistSet(string key)
        {
            ...
            AcquireSetLock();
            QueueCommand(x => x.Execute($"UPDATE {prefix}HF_SET SET EXPIRE_AT = NULL WHERE KEY = :KEY", new { KEY = key }));
        }
        ...
        public override void RemoveSet(string key)
        {
            ...
            AcquireSetLock();
            QueueCommand(x => x.Execute($"DELETE FROM {prefix}HF_SET WHERE KEY = :KEY", new { KEY = key }));
        }
        ...
        public override void PersistList(string key)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}HF_LIST SET EXPIRE_AT = NULL WHERE KEY = :KEY", new { KEY = key }));
        }
 ...
 WHEN NOT MATCHED THEN
      ...
      VALUES ({prefix}HF_SEQUENCE.NEXTVAL, :KEY, :VALUE, :FIELD)
",
        ...
        public override void ExpireHash(string key, TimeSpan expireIn)
        {
            ...
            QueueCommand(x =>
                x.Execute(
                    $"UPDATE {prefix}HF_HASH SET EXPIRE_AT = :EXPIRE_AT WHERE KEY = :KEY",
                    new { KEY = key, EXPIRE_AT = DateTime.UtcNow.Add(expireIn) }));
        }
        ...
        public override void RemoveHash(string key)
        {
            ...
            AcquireHashLock();
            QueueCommand(x => x.Execute($"DELETE FROM {prefix}HF_HASH WHERE KEY = :KEY", new { KEY = key }));
        }
